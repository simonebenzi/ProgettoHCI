...
The buttons below the rectangular area allow to cancel the last entry of a figure in the area ('Back' button), to restart the game in progress ('Reset' button), to start a new game ('New area' button) and return to the Main Menu ('Menu' button)." };
        ...
        public static string[] winSuggestion = { "Premi il pulsante 'Nuova area' per iniziare una nuova partita", "Press the 'New area' button to start a new game" };
